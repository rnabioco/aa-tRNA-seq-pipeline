...
dorado basecaller --emit-moves -r -v rna004_130bps_sup@v3.0.1 sample1/pod5_pass > sample1/sample1.unmapped.bam
dorado basecaller --emit-moves -r -v rna004_130bps_sup@v3.0.1 sample2/pod5_pass > sample2/sample2.unmapped.bam
